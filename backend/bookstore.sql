...
-- Cover images from Open Library: https://covers.openlibrary.org/b/isbn/{ISBN}-L.jpg
INSERT INTO BOOKS (isbn, title, publisher_id, publication_year, price, category, quantity_in_stock, threshold_quantity, cover_image) VALUES
-- Science
('9780553380163', 'A Brief History of Time', 1, 1988, 18.99, 'Science', 50, 10, 'https://covers.openlibrary.org/b/isbn/9780553380163-L.jpg'),
('9780345539434', 'Cosmos', 1, 1980, 22.00, 'Science', 55, 12, 'https://covers.openlibrary.org/b/isbn/9780345539434-L.jpg'),
('9780141439518', 'The Origin of Species', 1, 1859, 15.99, 'Science', 30, 8, 'https://covers.openlibrary.org/b/isbn/9780141439518-L.jpg'),
('9780307474278', 'The Elegant Universe', 2, 1999, 17.99, 'Science', 45, 10, 'https://covers.openlibrary.org/b/isbn/9780307474278-L.jpg'),
('9780393609394', 'Astrophysics for People in a Hurry', 3, 2017, 14.99, 'Science', 80, 15, 'https://covers.openlibrary.org/b/isbn/9780393609394-L.jpg'),
('9780143111368', 'The Gene: An Intimate History', 1, 2016, 20.00, 'Science', 35, 8, 'https://covers.openlibrary.org/b/isbn/9780143111368-L.jpg'),
('9780062316097', 'Sapiens: A Brief History of Humankind', 2, 2015, 24.99, 'Science', 95, 20, 'https://covers.openlibrary.org/b/isbn/9780062316097-L.jpg'),
('9780525559474', 'The Body: A Guide for Occupants', 1, 2019, 19.99, 'Science', 60, 12, 'https://covers.openlibrary.org/b/isbn/9780525559474-L.jpg'),
('9780374533557', 'Thinking, Fast and Slow', 4, 2011, 18.00, 'Science', 70, 15, 'https://covers.openlibrary.org/b/isbn/9780374533557-L.jpg'),
('9780143127741', 'Sapiens Graphic Novel', 2, 2020, 29.99, 'Science', 40, 10, 'https://covers.openlibrary.org/b/isbn/9780143127741-L.jpg'),

-- History
('9780062316110', 'Sapiens: A Brief History of Humankind', 2, 2011, 24.99, 'History', 75, 15, 'https://covers.openlibrary.org/b/isbn/9780062316110-L.jpg'),
('9781524763138', 'Becoming', 1, 2018, 32.50, 'History', 100, 20, 'https://covers.openlibrary.org/b/isbn/9781524763138-L.jpg'),
('9780399590504', 'Educated: A Memoir', 1, 2018, 28.00, 'History', 80, 15, 'https://covers.openlibrary.org/b/isbn/9780399590504-L.jpg'),
('9780062694690', 'A Peoples History of the United States', 2, 1980, 19.99, 'History', 40, 10, 'https://covers.openlibrary.org/b/isbn/9780062694690-L.jpg'),
('9780393354324', 'Guns, Germs, and Steel', 3, 1997, 26.99, 'History', 48, 10, 'https://covers.openlibrary.org/b/isbn/9780393354324-L.jpg'),
('9780316346627', 'Outliers: The Story of Success', 3, 2008, 17.99, 'Self-Help', 60, 12, 'https://covers.openlibrary.org/b/isbn/9780316346627-L.jpg'),
('9780143038580', 'Team of Rivals', 1, 2005, 22.00, 'History', 35, 8, 'https://covers.openlibrary.org/b/isbn/9780143038580-L.jpg'),
('9780060838676', 'The Rise and Fall of the Third Reich', 3, 1960, 25.99, 'History', 28, 6, 'https://covers.openlibrary.org/b/isbn/9780060838676-L.jpg'),
('9780679720201', '1776', 3, 2005, 18.00, 'History', 42, 10, 'https://covers.openlibrary.org/b/isbn/9780679720201-L.jpg'),
('9780307352156', 'Unbroken', 1, 2010, 18.00, 'History', 65, 12, 'https://covers.openlibrary.org/b/isbn/9780307352156-L.jpg'),
('9780307887436', 'The Warmth of Other Suns', 1, 2010, 18.99, 'History', 38, 8, 'https://covers.openlibrary.org/b/isbn/9780307887436-L.jpg'),
('9780735211292', 'Atomic Habits', 1, 2018, 27.00, 'History', 120, 25, 'https://covers.openlibrary.org/b/isbn/9780735211292-L.jpg'),
('9780525434290', 'The Splendid and the Vile', 1, 2020, 19.99, 'History', 55, 12, 'https://covers.openlibrary.org/b/isbn/9780525434290-L.jpg'),

-- Religion
('9780807067048', 'Mans Search for Meaning', 1, 1946, 14.99, 'Religion', 45, 10, 'https://covers.openlibrary.org/b/isbn/9780807067048-L.jpg'),
('9780345384560', 'A History of God', 1, 1993, 21.50, 'Religion', 35, 8, 'https://covers.openlibrary.org/b/isbn/9780345384560-L.jpg'),
('9780060652937', 'Mere Christianity', 2, 1952, 15.99, 'Religion', 50, 10, 'https://covers.openlibrary.org/b/isbn/9780060652937-L.jpg'),
('9780061120084', 'The Alchemist', 2, 1988, 16.99, 'Religion', 90, 18, 'https://covers.openlibrary.org/b/isbn/9780061120084-L.jpg'),
('9780062511409', 'The Monk Who Sold His Ferrari', 2, 1997, 17.00, 'Religion', 45, 10, 'https://covers.openlibrary.org/b/isbn/9780062511409-L.jpg'),
('9780062457714', 'The Seven Spiritual Laws of Success', 1, 1994, 14.00, 'Religion', 40, 8, 'https://covers.openlibrary.org/b/isbn/9780062457714-L.jpg'),
('9780553109535', 'The Art of Happiness', 1, 1998, 16.00, 'Religion', 55, 12, 'https://covers.openlibrary.org/b/isbn/9780553109535-L.jpg'),
('9780743223188', 'The Purpose Driven Life', 3, 2002, 17.99, 'Religion', 60, 12, 'https://covers.openlibrary.org/b/isbn/9780743223188-L.jpg'),
('9780062515872', 'The Untethered Soul', 2, 2007, 17.99, 'Religion', 48, 10, 'https://covers.openlibrary.org/b/isbn/9780062515872-L.jpg'),
('9780062236845', 'Daring Greatly', 1, 2012, 18.00, 'Religion', 52, 10, 'https://covers.openlibrary.org/b/isbn/9780062236845-L.jpg'),

-- Art (Literature/Fiction)
('9780452284234', 'The Alchemist', 2, 1988, 14.99, 'Art', 65, 15, 'https://covers.openlibrary.org/b/isbn/9780452284234-L.jpg'),
('9780316769488', 'The Catcher in the Rye', 3, 1951, 13.99, 'Art', 55, 12, 'https://covers.openlibrary.org/b/isbn/9780316769488-L.jpg'),
('9780679783268', 'Pride and Prejudice', 4, 1813, 12.99, 'Art', 40, 10, 'https://covers.openlibrary.org/b/isbn/9780679783268-L.jpg'),
('9780451524935', '1984', 1, 1949, 15.99, 'Art', 85, 18, 'https://covers.openlibrary.org/b/isbn/9780451524935-L.jpg'),
('9780446310789', 'To Kill a Mockingbird', 2, 1960, 16.99, 'Art', 95, 20, 'https://covers.openlibrary.org/b/isbn/9780446310789-L.jpg'),
('9780743273565', 'The Great Gatsby', 3, 1925, 15.00, 'Art', 70, 15, 'https://covers.openlibrary.org/b/isbn/9780743273565-L.jpg'),
('9780141439600', 'Great Expectations', 1, 1861, 12.99, 'Art', 35, 8, 'https://covers.openlibrary.org/b/isbn/9780141439600-L.jpg'),
('9780140449136', 'Crime and Punishment', 1, 1866, 16.00, 'Art', 42, 10, 'https://covers.openlibrary.org/b/isbn/9780140449136-L.jpg'),
('9780140449242', 'War and Peace', 1, 1869, 20.00, 'Art', 30, 6, 'https://covers.openlibrary.org/b/isbn/9780140449242-L.jpg'),
('9780060883287', 'One Hundred Years of Solitude', 2, 1967, 17.00, 'Art', 48, 10, 'https://covers.openlibrary.org/b/isbn/9780060883287-L.jpg'),
('9780439708180', 'Harry Potter and the Sorcerers Stone', 6, 1997, 12.99, 'Art', 150, 30, 'https://covers.openlibrary.org/b/isbn/9780439708180-L.jpg'),
('9780439064873', 'Harry Potter and the Chamber of Secrets', 6, 1998, 12.99, 'Art', 140, 28, 'https://covers.openlibrary.org/b/isbn/9780439064873-L.jpg'),
('9780439136365', 'Harry Potter and the Prisoner of Azkaban', 6, 1999, 12.99, 'Art', 135, 27, 'https://covers.openlibrary.org/b/isbn/9780439136365-L.jpg'),
('9780547928227', 'The Hobbit', 4, 1937, 15.99, 'Art', 80, 16, 'https://covers.openlibrary.org/b/isbn/9780547928227-L.jpg'),
('9780544003415', 'The Lord of the Rings', 4, 1954, 35.00, 'Art', 60, 12, 'https://covers.openlibrary.org/b/isbn/9780544003415-L.jpg'),
('9780007141326', 'The Lion, the Witch and the Wardrobe', 2, 1950, 12.99, 'Art', 55, 12, 'https://covers.openlibrary.org/b/isbn/9780007141326-L.jpg'),
('9780553293357', 'Foundation', 1, 1951, 17.00, 'Art', 45, 10, 'https://covers.openlibrary.org/b/isbn/9780553293357-L.jpg'),
('9780307474728', 'The Da Vinci Code', 1, 2003, 17.00, 'Art', 75, 15, 'https://covers.openlibrary.org/b/isbn/9780307474728-L.jpg'),
('9780062073488', 'Murder on the Orient Express', 2, 2011, 15.99, 'Art', 50, 10, 'https://covers.openlibrary.org/b/isbn/9780062073488-L.jpg'),
('9781501142970', 'It', 3, 1986, 19.99, 'Art', 55, 12, 'https://covers.openlibrary.org/b/isbn/9781501142970-L.jpg'),
('9780385333481', 'The Shining', 1, 1977, 17.00, 'Art', 48, 10, 'https://covers.openlibrary.org/b/isbn/9780385333481-L.jpg'),
('9780307744432', 'The Girl with the Dragon Tattoo', 1, 2005, 17.00, 'Art', 60, 12, 'https://covers.openlibrary.org/b/isbn/9780307744432-L.jpg'),
('9780143127550', 'The Handmaids Tale', 1, 1985, 16.00, 'Art', 65, 14, 'https://covers.openlibrary.org/b/isbn/9780143127550-L.jpg'),
('9780307387899', 'The Road', 1, 2006, 16.00, 'Art', 42, 10, 'https://covers.openlibrary.org/b/isbn/9780307387899-L.jpg'),
('9780316055437', 'The Secret History', 1, 1992, 18.00, 'Art', 38, 8, 'https://covers.openlibrary.org/b/isbn/9780316055437-L.jpg'),
('9781501110368', 'It Ends with Us', 3, 2016, 17.99, 'Art', 110, 22, 'https://covers.openlibrary.org/b/isbn/9781501110368-L.jpg'),
('9781668001226', 'It Starts with Us', 3, 2022, 18.99, 'Art', 95, 20, 'https://covers.openlibrary.org/b/isbn/9781668001226-L.jpg'),
('9780735222359', 'Where the Crawdads Sing', 1, 2018, 18.00, 'Art', 85, 18, 'https://covers.openlibrary.org/b/isbn/9780735222359-L.jpg'),
('9780593321201', 'Tomorrow and Tomorrow and Tomorrow', 1, 2022, 28.00, 'Art', 70, 15, 'https://covers.openlibrary.org/b/isbn/9780593321201-L.jpg'),
('9781501161933', 'The Seven Husbands of Evelyn Hugo', 3, 2017, 17.00, 'Art', 90, 18, 'https://covers.openlibrary.org/b/isbn/9781501161933-L.jpg'),

-- Self-Help/Business
('9780316017930', 'Outliers', 3, 2008, 18.99, 'Self-Help', 70, 15, 'https://covers.openlibrary.org/b/isbn/9780316017930-L.jpg'),
('9780812981605', 'The Power of Habit', 1, 2012, 18.00, 'Self-Help', 75, 15, 'https://covers.openlibrary.org/b/isbn/9780812981605-L.jpg'),
('9780593135204', 'Think Again', 1, 2021, 28.00, 'Self-Help', 65, 14, 'https://covers.openlibrary.org/b/isbn/9780593135204-L.jpg'),
('9780525429586', 'Deep Work', 1, 2016, 18.00, 'Self-Help', 55, 12, 'https://covers.openlibrary.org/b/isbn/9780525429586-L.jpg'),
('9780143126560', 'Quiet: The Power of Introverts', 1, 2012, 18.00, 'Self-Help', 58, 12, 'https://covers.openlibrary.org/b/isbn/9780143126560-L.jpg');
